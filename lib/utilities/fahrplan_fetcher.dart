...
class FahrplanFetcher {
  ...
  static Future<Fahrplan> fetchFahrplan(bool fromCache) async {
    ...
    if (fromCache) {
      ...
      if (connectivityResult == ConnectivityResult.mobile ||
        ...
        Uri changelog = Uri.parse(
            'https://cfp.eh20.easterhegg.eu/eh20/schedule/changelog/');
        final responseChangelog = await http
            .get(changelog)
            .timeout(Duration(seconds: Constants.LOADING_TIMEOUT))
